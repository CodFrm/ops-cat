...
import {external_edit_svc} from '../models';
...
export function ApplyExternalEditMerge(arg1:external_edit_svc.MergeApplyRequest):Promise<external_edit_svc.SaveResult>;
...
export function CompareExternalEditSession(arg1:string):Promise<external_edit_svc.CompareResult>;
...
export function ContinueExternalEditSession(arg1:string):Promise<external_edit_svc.Session>;
...
export function DeleteExternalEditSession(arg1:string,arg2:boolean):Promise<external_edit_svc.DeleteResult>;
...
export function GetExternalEditSettings():Promise<external_edit_svc.Settings>;
...
export function ListExternalEditSessions():Promise<Array<external_edit_svc.Session>>;
...
export function OpenExternalEdit(arg1:external_edit_svc.OpenRequest):Promise<external_edit_svc.Session>;
...
export function RecoverExternalEditSession(arg1:string):Promise<external_edit_svc.Session>;
...
export function RefreshExternalEditSession(arg1:string):Promise<external_edit_svc.Session>;
...
export function ResolveExternalEditConflict(arg1:string,arg2:string):Promise<external_edit_svc.SaveResult>;
...
export function SaveExternalEditSession(arg1:string):Promise<external_edit_svc.SaveResult>;

export function SaveExternalEditSettings(arg1:external_edit_svc.SettingsInput):Promise<external_edit_svc.Settings>;
